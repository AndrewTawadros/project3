            ...
            <div className="container-fluid pt-5 bg-footer">
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2020 Quick Food. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Paul, Andrew, Derek, Joel, Kendirck</span></p>
                    </div>
                </div>
            </div>
        );
